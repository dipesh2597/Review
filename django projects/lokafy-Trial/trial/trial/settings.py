...
with open(os.path.join(os.path.dirname(BASE_DIR),"confs/config_file.json")) as config_file: CONFIG_FILE = json.load(config_file)

# SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = '$j0be%ek6-$hx!e&mg10h$6+cg*l(sa0*xcqub38)20ps9!#as'
